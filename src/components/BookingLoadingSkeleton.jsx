...
const BookingLoadingSkeleton = ({ variant = 'default' }) => {
    return (
        <div className="min-h-screen bg-[#F5F5FA] animate-pulse">
            {/* Header Skeleton */}
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {variant === 'seats' && (
                    <>
                        {/* Screen Skeleton */}
                        <div className="mb-8">
                            <div className="h-12 bg-gray-200 rounded-t-2xl w-full"></div>
                            <div className="h-2 bg-gray-100 rounded-b w-full"></div>
                        </div>
