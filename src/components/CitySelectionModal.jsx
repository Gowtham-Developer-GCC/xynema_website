...
const POPULAR_CITY_CONFIG = [
    { name: 'Mumbai', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/mumbai.png)', WebkitMaskImage: 'url(/assets/cites/mumbai.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Delhi NCR', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/delhi.png)', WebkitMaskImage: 'url(/assets/cites/delhi.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Bengaluru', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/bengaluru.png)', WebkitMaskImage: 'url(/assets/cites/bengaluru.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Hyderabad', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/hyderabad.png)', WebkitMaskImage: 'url(/assets/cites/hyderabad.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Ahmedabad', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/ahmedabad.png)', WebkitMaskImage: 'url(/assets/cites/ahmedabad.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Chennai', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/chennai.png)', WebkitMaskImage: 'url(/assets/cites/chennai.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Kolkata', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/kolkata.png)', WebkitMaskImage: 'url(/assets/cites/kolkata.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Pune', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/pune.png)', WebkitMaskImage: 'url(/assets/cites/pune.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    ...
    { name: 'Goa', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/goa.png)', WebkitMaskImage: 'url(/assets/cites/goa.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Chandigarh', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/chandigarh.png)', WebkitMaskImage: 'url(/assets/cites/chandigarh.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
    { name: 'Puducherry', icon: <div className="w-12 h-12 bg-current" style={{ maskImage: 'url(/assets/cites/puducherry.png)', WebkitMaskImage: 'url(/assets/cites/puducherry.png)', maskSize: 'contain', WebkitMaskSize: 'contain', maskRepeat: 'no-repeat', WebkitMaskRepeat: 'no-repeat', maskPosition: 'center', WebkitMaskPosition: 'center' }} /> },
];
