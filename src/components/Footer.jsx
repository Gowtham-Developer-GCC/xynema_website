...
const Footer = () => {
    return (
        <footer className="bg-[#1a202c] text-gray-400 font-sans text-sm relative z-10 w-full mt-20 border-t border-gray-800">
            {/* Main Footer Content */}
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                            ...
                            <a href="mailto:care@xynema.in" className="flex items-center gap-4 text-gray-400 hover:text-primary transition-all group">
                                ...
                                <div className="flex flex-col gap-0.5">
                                    {/* <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest leading-none">FOR CUSTOMERS SERVICE</span> */}
            ...
            <div className="bg-[#151924]/80 backdrop-blur-sm py-4 px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-gray-800/30">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center lg:border-r border-gray-800/80 pr-6 mr-2">
                        <span className="text-[10px] text-gray-600 font-bold uppercase tracking-widest">Download App</span>
                    </div>
                    <a href="#" className="transition-all hover:scale-105 active:scale-95 duration-200 shadow-lg rounded-md overflow-hidden border border-white/5">
                        <img
