...
const MovieCard = memo(({ movie }) => {
    ...
    >
        ...
        <div className="pt-1 flex flex-col w-full">
            <h3 className="text-[17px] font-medium text-black dark:text-gray-100 group-hover:text-primary dark:group-hover:text-primary transition-colors leading-tight line-clamp-2 font-roboto">
                {movie.title}
            </h3>
