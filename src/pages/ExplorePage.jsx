...
const EventCard = memo(({ event }) => {
    ...
    return (
        <Link to={eventLink} className="group block w-full">
            <div className={`bg-white dark:bg-[#1a1c23] rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.3)] border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl flex flex-col h-full transition-all duration-300 cursor-pointer ${event.delayClass || ''}`}>
