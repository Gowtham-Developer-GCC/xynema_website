...
const ParkPaymentPage = () => {
    ...
    const { park, selectedDate, counts, totalPrice, ticketTypes } = location.state || {};
        ...
        <div className="min-h-screen bg-[#F5F5FA] dark:bg-[#0f1115] transition-colors duration-300 pb-24">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <section className="bg-white dark:bg-[#16181d] rounded-[40px] p-10 border border-gray-100 dark:border-gray-800">
                            ...
                            <div className="bg-[#F5F5FA] dark:bg-gray-800/20 rounded-[32px] p-8 mb-8 border border-gray-50 dark:border-gray-800">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {['Google Pay', 'PhonePe', 'Paytm'].map(app => (
                                        <div key={app} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-primary hover:shadow-lg transition-all group">
                            ...
                            <div className="space-y-4">
                                {[
                                    { name: 'Credit / Debit Card', icon: CreditCard, subtitle: 'Visa, Mastercard, Amex, Rupay' },
                                    { name: 'Wallets', icon: Wallet, subtitle: 'Amazon Pay, Mobikwik, Freecharge' },
                                    { name: 'Net Banking', icon: Landmark, subtitle: 'All major banks supported' }
                                ].map((method, idx) => (
                                    <div key={idx} className="bg-white dark:bg-transparent rounded-3xl p-6 border border-gray-100 dark:border-gray-800 flex items-center justify-between cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-all group">
                                        <div className="flex items-center gap-5">
                                            <div className="p-3 bg-gray-50 dark:bg-gray-800 group-hover:bg-primary/10 rounded-2xl transition-colors">
                                                <method.icon className="w-6 h-6 text-gray-400 group-hover:text-primary" />
                                            </div>
                                            <div>
                                        ...
                                        <div className="w-10 h-10 bg-gray-50 dark:bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-primary group-hover:translate-x-1 transition-all">
                                            <ChevronLeft className="w-5 h-5 text-gray-300 group-hover:text-white rotate-180" />
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="sticky top-[110px] space-y-6">
                            <div className="bg-white dark:bg-[#16181d] rounded-[40px] p-10 border border-gray-100 dark:border-gray-800 shadow-xl shadow-gray-200/50 dark:shadow-none">
                                ...
                                <div className="pt-6 border-t border-gray-100 dark:border-gray-800 mb-10">
                                    ...
                                    <button 
                                        className="w-full py-5 bg-primary/40 text-white font-black tracking-widest uppercase rounded-2xl cursor-not-allowed"
                                    >
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-[#0f1115]/80 backdrop-blur-xl border-t border-gray-100 dark:border-gray-800 z-40">
                <div className="flex items-center justify-between gap-6 max-w-md mx-auto">
                    ...
                    <button className="flex-1 py-4 bg-primary/40 text-white font-black tracking-widest uppercase rounded-2xl cursor-not-allowed">
                         Pay now
                    </button>
                </div>
            </div>
